...
class IdentityVerificationService {
            ...
            <form id="ivs-verification-form" method="post" enctype="multipart/form-data">
                ...
                <div class="ivs-form-section">
                    ...
                    <div class="ivs-form-row">
                        ...
                        <div class="ivs-form-col">
                            <label class="ivs-label">Expiry Date of Passport/CNIC <span class="ivs-required">*</span></label>
                            <input type="date" name="document_expiry" class="ivs-input" required>
                        </div>
                    </div>
                ...
                <div class="ivs-form-section">
                    ...
                    <div class="ivs-form-row">
                        ...
                        <div class="ivs-form-col">
                            <label class="ivs-label">Province/State <span class="ivs-required">*</span></label>
                            <input type="text" name="address_state" class="ivs-input" placeholder="Enter province or state" required>
                        </div>
                    </div>
                ...
                <div class="ivs-form-section">
                    ...
                    <div class="ivs-form-row">
                        <div class="ivs-form-col">
                            <label class="ivs-label">Upload a photo of yourself (selfie) holding a photo ID <span class="ivs-required">*</span></label>
                            <input type="file" name="selfie_id[]" class="ivs-file-input" accept=".jpg,.jpeg,.png,.pdf" multiple required>
                            <div class="ivs-file-hint">
                                <p><strong>Max. file size: 3 GB, Max. files: 5.</strong></p>
                                <p>1. Take the photo in a room with enough light</p>
                                <p>2. Select the highest photo quality on the device you use to take the photo</p>
                                <p>3. Hold up the document next to your face, like in the image below</p>
                                <p>4. Make sure both your face and ID are clear on the photo — nothing on the ID can be covered or censored</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ivs-form-section">
                    <h3 class="ivs-heading">Business Activity & Details</h3>
                    <div class="ivs-form-row">
                        <div class="ivs-form-col">
                            <label class="ivs-label">Business Activity SIC Code <span class="ivs-required">*</span></label>
                            <input type="text" name="sic_code" class="ivs-input" placeholder="Enter 5-digit SIC Code (e.g. 62020)" required>
                        </div>
                    </div>
                    <div class="ivs-form-row">
                        <div class="ivs-form-col">
                            <label class="ivs-label">Description of Business Activities</label>
                            <textarea name="business_description" class="ivs-input" rows="3" placeholder="Provide a brief description of your business activities..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <!-- Source of Funds -->
                <div class="ivs-form-section">
                    <h3 class="ivs-heading">SOURCE OF FUNDS (SOF)</h3>
                    <hr class="ivs-divider">
                    
                    <div class="ivs-form-row">
                        <div class="ivs-form-col">
                            <h4 class="ivs-subheading">What is the source of funds <span class="ivs-required">*</span></h4>
                            <div class="ivs-checkbox-group">
                                <label class="ivs-checkbox-label">
                                    <input type="checkbox" name="source_of_funds[]" value="personal_savings">
                                    <span class="ivs-checkbox-text">Personal savings</span>
                                </label>
                                <label class="ivs-checkbox-label">
                                    <input type="checkbox" name="source_of_funds[]" value="salary_income">
                                    <span class="ivs-checkbox-text">Salary income</span>
                                </label>
                                <label class="ivs-checkbox-label">
                                    <input type="checkbox" name="source_of_funds[]" value="business_revenue">
                                    <span class="ivs-checkbox-text">Business revenue</span>
                                </label>
                                <label class="ivs-checkbox-label">
                                    <input type="checkbox" name="source_of_funds[]" value="investment">
                                    <span class="ivs-checkbox-text">Investment</span>
                                </label>
                                <label class="ivs-checkbox-label">
                                    <input type="checkbox" name="source_of_funds[]" value="loan">
                                    <span class="ivs-checkbox-text">Loan</span>
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    public function process_form() {
        ...
        $file_fields = array('photo_id', 'selfie_id', 'address_proof');
        ...
        $form_data = array(
            ...
            'document_expiry' => sanitize_text_field($_POST['document_expiry']),
            'issuance_country' => sanitize_text_field($_POST['issuance_country']),
            'registered_email' => sanitize_email($_POST['registered_email']),
            ...
            // Source of funds
            'source_of_funds' => isset($_POST['source_of_funds']) ? array_map('sanitize_text_field', $_POST['source_of_funds']) : array(),
    ...
    public function save_form_data_to_order($order_id) {
        ...
        if ($form_data && !empty($form_data['director_name'])) {
            ...
            $order_note .= "Expiry Date: {$form_data['document_expiry']}\n";
            ...
            $order_note .= "Source of Funds: " . implode(', ', $form_data['source_of_funds']) . "\n";
            ...
            $order_note .= "- Selfie with ID: " . (isset($form_data['uploaded_files']['selfie_id']) ? count($form_data['uploaded_files']['selfie_id']) : '0') . " files\n";
        ...
        if ($director_name) {
            ...
            <div class="order_data_column" style="width: 100%;">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <p><strong>Expiry Date:</strong> <?php echo esc_html($order->get_meta('_ivs_document_expiry')); ?></p>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <p><strong>State/Province:</strong> <?php echo esc_html($order->get_meta('_ivs_address_state')); ?></p>
                ...
                <div style="margin-bottom: 20px;">
                    <h4 style="color: #333; border-bottom: 1px solid #ddd; padding-bottom: 5px;">SOURCE OF FUNDS (SOF)</h4>
                    <?php
    ...
    public function add_to_order_emails($order, $sent_to_admin, $plain_text, $email) {
        ...
        if ($director_name) {
            if ($plain_text) {
                ...
                echo "Expiry Date: " . $order->get_meta('_ivs_document_expiry') . "\n";
                ...
                echo "State/Province: " . $order->get_meta('_ivs_address_state') . "\n";
                        ...
                        <div class="ivs-service-card" style="background: #f9f9f9; padding: 20px; margin-bottom: 20px; border-radius: 8px; border: 1px solid #00000069; margin-top: 40px;">
                            ...
                            <div style="margin-bottom: 15px;">
                                ...
                                <div style="display: flex; flex-wrap: wrap; gap: 15px;">
                                    ...
                                    $file_types = array('photo_id', 'selfie_id', 'address_proof');
                                    $file_labels = array(
                                        'photo_id' => 'Photo ID',
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script('ivs-frontend-script', false, array('jquery'), '1.0', true);
        wp_add_inline_script('ivs-frontend-script', $this->get_frontend_js());
        
        // Localize script
        wp_localize_script('ivs-frontend-script', 'ivs_ajax', array(
    ...
    private function get_frontend_js() {
        ...
        jQuery(document).ready(function($) {
            ...
            $('#ivs-verification-form').on('submit', function(e) {
                ...
                // Validate source of funds checkbox
                var sourceFundsChecked = $('input[name=\"source_of_funds[]\"]:checked').length;
                if (sourceFundsChecked === 0) {
                    alert('Please select at least one source of funds');
                    return false;
                }
